...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    # 长度截断重试：思考吃光预算、正文为空（09-20 实测 Bonsai）
    "length_retry": {
        "zh": "⛔ 上一轮你的思考用完了生成长度上限，正文一个字都没写。这一轮请**直接写出答案正文**（可先用一两句话梳理），不要再展开长篇推理。",
        "en": "⛔ Your previous round used the entire output budget on thinking and wrote no answer. This round, write the answer directly (a sentence or two of reasoning is fine) — do not expand into long reasoning.",
        "ja": "⛔ 前回は思考で出力上限を使い切り、本文がありませんでした。今回は**本文を直接**書いてください（1〜2文の整理は可）。長い推論は展開しないでください。",
        "ru": "⛔ В прошлом раунде всё бюджетное место ушло на рассуждения, а ответа нет. В этом раунде напишите ответ сразу (1–2 предложения рассуждения допустимы), не разворачивайте длинные рассуждения.",
    },
